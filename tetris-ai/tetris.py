...
class Tetris:
    ...
    def play(self, x, rotation, episode, render=False, render_delay=None, record=False):
        ...
        t_bumpiness, m_bumpiness = self._bumpiness(self.board)
